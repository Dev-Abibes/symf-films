...
class getMovieControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Service/TMDbService.php';

        $container->services['App\\Controller\\MovieController'] = $instance = new \App\Controller\MovieController(new \App\Service\TMDbService());
