...
class getMovieControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Service/TmbdClient.php';

        $container->services['App\\Controller\\MovieController'] = $instance = new \App\Controller\MovieController(new \App\Service\TmdbClient(($container->privates['.debug.tmdb.client'] ?? self::get_Debug_Tmdb_ClientService($container)), ($container->services['cache.app'] ?? self::getCache_AppService($container))));
        ...
        ]))->withContext('App\\Controller\\MovieController', $container));
